...
const DirectTaxClient = () => {
  const directTaxServices = [
    ...
    },
    {
      ...
      description:
        "We offer end-to-end TDS services including monthly deduction calculations, challan payments, return filing, correction statements, Form 16/16A generation, and resolution of TDS notices.",
      icon: "⏰",
    },
    {
    ...
    },
    {
      ...
      description:
        "We assist in drafting replies to notices, representing before AO, CIT(A), and ITAT, and managing assessments, reassessments, and appeals.",
      icon: "💸",
    },
  ];
...
export default DirectTaxClient;
